...
| GET | `/favicon.ico`、`/favicon-*.png`、`/apple-touch-icon.png`、`/android-chrome-*.png`、`/manifest.json` | 公开 | 站点品牌图标与 PWA manifest；`.ico` 与 `apple-touch-icon.png` 覆盖浏览器、爬虫和 iOS 对根路径的隐式请求 |
